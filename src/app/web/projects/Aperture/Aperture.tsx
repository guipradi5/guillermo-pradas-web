  ...
  return (
    <div className='project-window-body'>
      ...
      <p>
        ...
        The website is made in <b>vanila HTML, CSS and Javscript</b>. It features a carrousel added through a library, an online store, a story and company section, a blog, etc.
        <br/><br/>
        Another little thing added on on my part, was an easter egg. If you type in the search bar &quot;rattman&quot; you'll be redirected to a console like environment where you can read a diaries from a character from the games.
        <br/><br/>
