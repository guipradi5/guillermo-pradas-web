...
export default function MarbleHornets () {
  return (
    <div className='project-window-body'>
      <h2>Marble Hornets mock-up website</h2>
      <h6><a href="https://citmalumnes.upc.es/~guillermopdl/Marble_Hornets_Guillermo_Pradas/" target="_blank">Link to the website</a></h6>
      <p>
